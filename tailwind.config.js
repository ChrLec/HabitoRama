...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      animation: {
        'blob-breath': 'blob-breath 5s ease-in-out infinite alternate',
        'delimiter-breath': 'fadeout 5s ease-in-out infinite alternate',
        breathe: 'breathe 18s ease-in-out infinite',
        'pulse-slow': 'pulse 3s cubic-bezier(0.4, 0, 0.6, 1) infinite',
        'upward-scroll': 'upward-scroll 20s linear infinite'
      },
      borderWidth: {
        '3': '3px',
        '6': '6px'
